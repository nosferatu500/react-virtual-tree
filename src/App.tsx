        ...
        children: [
            {
                ...
                children: [
                    ...
                    { id: "1.3", name: "main.jsx", type: "file", children: [] },
                    {
                        id: "1.4",
                        name: "components",
                        type: "folder",
                        children: [
                            { id: "1.4.1", name: "Header.js", type: "file", children: [] },
                            { id: "1.4.2", name: "Footer.js", type: "file", children: [] },
                        ],
                        data: { owner: "" },
                    },
                ],
            ...
            },
            {
                ...
                type: "folder",
                children: [
                    { id: "2.1", name: "button.css", type: "file", children: [] },
                    { id: "2.2", name: "Button.stories.ts", type: "file", children: [] },
                    { id: "2.3", name: "Button.tsx", type: "file", children: [] },
                    { id: "2.4", name: "Configure.mdx", type: "folder", children: [] },
                ],
                data: { owner: "" },
            },
            { id: "3", name: "package.json", type: "file", children: [], data: { owner: "" } },
        ],
        data: { owner: "" },
    },
];
